...
public class CharacterExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public CharacterExpandableAdapter(Context context, List<String> groupList,
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context)
                    .inflate(R.layout.character_group_item, parent, false);
        }
        TextView groupTitle = convertView.findViewById(R.id.characterGroupView);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context)
                    .inflate(R.layout.character_child_item, parent, false);
        }
